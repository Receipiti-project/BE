...
public enum GeneralErrorCode implements BaseErrorCode {
    ...
    CARD_MESSAGE_UNSUPPORTED(HttpStatus.UNPROCESSABLE_ENTITY, "CARD_MESSAGE_422", "지원하지 않는 카드 결제 문자 형식입니다."),
    CARD_MESSAGE_INFORMATION_INSUFFICIENT(HttpStatus.UNPROCESSABLE_ENTITY, "CARD_MESSAGE_INFO_422", "카드 결제 정보가 부족하거나 올바르지 않습니다."),
    CARD_MESSAGE_DUPLICATE(HttpStatus.CONFLICT, "CARD_MESSAGE_409", "이미 처리된 카드 결제 문자 요청입니다."),
    RECEIPT_INFORMATION_INSUFFICIENT(HttpStatus.UNPROCESSABLE_ENTITY, "RECEIPT_422", "영수증 정보를 충분히 확인할 수 없습니다."),
    RECEIPT_ANALYSIS_FAILED(HttpStatus.BAD_GATEWAY, "RECEIPT_502", "영수증 이미지 분석에 실패했습니다."),
